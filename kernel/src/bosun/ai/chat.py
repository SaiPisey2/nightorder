...
SYSTEM = """You are the Bosun assistant — embedded in an enterprise workflow \
...
Spec schema quick reference: apiVersion: bosun/v1, kind: Pipeline, name, project, \
...
async def _get_component_health() -> Any:
    from bosun.api.main import health_components
