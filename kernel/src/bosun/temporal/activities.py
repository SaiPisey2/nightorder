...
from bosun.contracts import StepContext, load_registry
from bosun.db import Event, Gate, Outbox, ResolvedParameter, Run, StepExecution, get_session
...
async def open_gate(input: dict) -> dict:
    ...
    -> {gate_id}"""
    from bosun.api.security import mint_gate_token  # kernel mints tokens, not channels/LLMs
    ...
    from bosun.contracts.base import GateNotification
...
async def execute_sandbox_job(input: dict) -> dict:
    ...
    from bosun.sandbox import run_sandbox_job
